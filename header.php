...
<nav id="navbar" class="bg-light navbar navbar-light">
  ...
  <div class="d-flex align-items-center w-100 position-relative">
    ...
    <button data-sf-theme="pink-grapefruit" class="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarDropdown" aria-controls="navbarDropdown" aria-expanded="false" aria-label="Toggle navigation">
